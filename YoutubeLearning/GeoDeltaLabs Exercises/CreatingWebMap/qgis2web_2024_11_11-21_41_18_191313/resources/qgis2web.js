...
map.getView().fit([-8968883.196781, 5365673.498658, -8947856.601620, 5389989.300881], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Emergency Services covering Landmarks in the KW region</h2>';
        return titleElement;
    })(),
